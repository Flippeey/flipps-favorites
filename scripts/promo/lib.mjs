...
export const PROMO_WORKSPACES = [
  {
    ...
    rootBookmarks: [
      ...
      { title: 'Datadog',      url: 'https://app.datadoghq.com' },
    ],
    folders: [
      {
        title: 'Project Apollo',
        bookmarks: [
          { title: 'Apollo — GitHub',  url: 'https://github.com' },
          { title: 'Apollo — Linear',  url: 'https://linear.app' },
    ...
    folders: [
      ...
      },
      {
        ...
        bookmarks: [
          ...
          { title: 'Colour Lovers',url: 'https://www.colourlovers.com' },
        ],
      },
      {
        title: 'Inspiration',
        bookmarks: [
          ...
          { title: 'Muzli',       url: 'https://muz.li' },
          { title: 'SiteInspire', url: 'https://www.siteinspire.com' },
        ],
      },
    ],
  },
